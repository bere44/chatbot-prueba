...
from langchain_google_genai import GoogleGenerativeAI  # LLM de Google
from langchain.vectorstores import Chroma  # Para crear el almacén de vectores
from langchain_google_genai import GoogleGenerativeAIEmbeddings  # Para usar embeddings
